...
describe('the assembled application', () => {
    ...
    it('answers an unknown route as JSON when HTML is not acceptable', async () => {
    ...
    it('renders the error view when HTML is acceptable', async () => {
    ...
    it('parses a JSON request body before the route sees it', async () => {
    ...
    it('rejects an unparsed body as a bad request rather than a server error', async () => {
