...
describe('Cloud Product Descriptor Manager', () => {
    var sut,
    ...
    describe('When adding with malformed product descriptor', () => {
        ...
        beforeEach((done) => {
            ...
            sut.add(productDescriptorId, data, (err, data) => {
                resultError = err;
                result = data;
                done();
            });
    ...
    describe('When adding', () => {
        ...
        it(' Should add file to S3', () => {
            expect(cloudFileDataRepositoryStub.addOrReplace).to.have.been.calledWith(
                '1c6528c8-819f-4d28-9cea-768b62e7bcdf',
    ...
    describe('When replacing existing product descriptor', () => {
        var productDescriptorId, data, existingData, _oldImpedanceFileId, expectedData, result;
        beforeEach((done) => {
            _oldImpedanceFileId = '5b61b280-bb73-11e4-ba72-9dec41bc3eb4';
            productDescriptorId = 'e8082b8c-f1ee-4a61-8ad7-0e55779ee6be';
    ...
    describe('When removing existing product descriptor', () => {
        var productDescriptorId, _oldImpedanceFileId;
        beforeEach((done) => {
            _oldImpedanceFileId = '5b61b280-bb73-11e4-ba72-9dec41bc3eb4';
            productDescriptorId = 'e8082b8c-f1ee-4a61-8ad7-0e55779ee6be';
