...
describe('S3 repository (round trip against a local object store)', function () {
    ...
    it('returns the stored bytes as a Buffer, not a stream', async () => {
    ...
    it('round-trips the original filename through object metadata', async () => {
    ...
    it('reports the key and href it stored under', async () => {
    ...
    it('generates a key when none is supplied, and stores under it', async () => {
    ...
    it('replaces the object when the same key is written twice', async () => {
    ...
    it('removes an object so that loading it afterwards fails', async () => {
    ...
    it('passes a failure to the callback rather than throwing', async () => {
